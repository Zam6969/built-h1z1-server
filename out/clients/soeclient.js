...
// ======================================================================
const EventEmitter = require("events").EventEmitter, SOEInputStream = require("../servers/SoeServer/soeinputstream").SOEInputStream, SOEOutputStream = require("../servers/SoeServer/soeoutputstream").SOEOutputStream, { Soeprotocol } = require("h1emu-core"), util = require("util"), fs = require("fs"), dgram = require("dgram"), debug = require("debug")("SOEClient");
...
class SOEClient {
    ...
    connect() {
        debug("Setting up connection for " +
            this._serverAddress +
            ":" +
            this._serverPort);
