...
exports.compressDependent = exports.compressBlock = exports.compress = exports.compressBound = exports.uncompress = void 0;
if (!Math.imul)
 ...
 * @private
 */
const uncompress = (input, output, sIdx, eIdx) => {
    sIdx = sIdx || 0;
...
const maxInputSize = 0x7e000000, minMatch = 4, hashLog = 16, hashShift = minMatch * 8 - hashLog, hashSize = 1 << hashLog, copyLength = 8, mfLimit = copyLength + minMatch, skipStrength = 6, mlBits = 4, mlMask = (1 << mlBits) - 1, runBits = 8 - mlBits, runMask = (1 << runBits) - 1, hasher = 2654435761;
// CompressBound returns the maximum length of a lz4 block, given it's uncompressed length
const compressBound = function (isize) {
    return isize > maxInputSize ? 0 : (isize + isize / 255 + 16) | 0;
};
exports.compressBound = compressBound;
const compress = function (src, dst, sIdx, eIdx) {
    ...
    return (0, exports.compressBlock)(src, dst, 0, hashTable, sIdx || 0, eIdx || dst.length);
};
exports.compress = compress;
const compressBlock = (src, dst, pos, hashTable, sIdx, eIdx) => {
    let dpos = sIdx;
    ...
    if (src.length > mfLimit) {
        const n = (0, exports.compressBound)(src.length);
        if (dlen < n)
        ...
        while (pos + minMatch < srcLength) {
            ...
            const hash = Math.imul(sequenceLowBits | (sequenceHighBits << 16), hasher) >>>
                hashShift;
...
exports.compressDependent = exports.compressBlock;
