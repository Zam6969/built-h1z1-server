...
exports.passengerSchema = exports.packTargetData = exports.firemodesSchema = exports.loadoutSlotsSchema = exports.loadoutSlotData = exports.itemDefinitionSchema = exports.equipmentSlotSchema = exports.equipmentCharacterSchema = exports.recipeData = exports.skyData = exports.containers = exports.containerData = exports.respawnLocationSchema = exports.fullPcSchema = exports.fullNpcSchema = exports.remoteWeaponExtraSchema = exports.remoteWeaponSchema = exports.attachmentSchema = exports.characterResourceData = exports.achievementSchema = exports.objectiveSchema = exports.collectionsSchema = exports.rewardBundleSchema = exports.currencySchema = exports.packItemWeaponData = exports.packItemSubData = exports.itemWeaponDetailSubSchema2 = exports.itemWeaponDetailSubSchema1 = exports.statSchema = exports.effectTagsSchema = exports.lightWeightNpcSchema = exports.lightWeightPcSchema = exports.identitySchema = exports.itemSchema = exports.packNpcComponent = exports.packInteractionComponent = exports.packVehicleReferenceData = exports.parseVehicleReferenceData = exports.vehicleReferenceSchema = exports.packItemDefinitionData = exports.profileSchema = exports.packPositionUpdateData = exports.readPositionUpdateData = exports.packSignedIntWith2bitLengthValue = exports.readSignedIntWith2bitLengthValue = exports.packUnsignedIntWith2bitLengthValue = exports.readUnsignedIntWith2bitLengthValue = exports.writePacketType = exports.readPacketType = void 0;
...
function packItemDefinitionData(obj) {
    ...
    const itemDefinitionData = h1z1_dataschema_1.default.pack(exports.itemDefinitionSchema, obj).data;
    data = Buffer.concat([data, itemDefinitionData]);
    const input = data;
    let output = Buffer.alloc(utils_1.LZ4.encodeBound(input.length));
    output = output.slice(0, utils_1.LZ4.encodeBlock(input, output));
...
exports.vehicleReferenceSchema = [
    {
        name: "move_info",
        type: "array",
        defaultValue: [{}],
...
function parseVehicleReferenceData(data, offset) {
    ...
    const result = h1z1_dataschema_1.default.parse(exports.vehicleReferenceSchema, data, 0).result;
    return {
        value: result,
        length: dataLength + 4,
    };
...
function packVehicleReferenceData(obj) {
    const data = h1z1_dataschema_1.default.pack(exports.vehicleReferenceSchema, obj);
    return data;
}
exports.packVehicleReferenceData = packVehicleReferenceData;
function packInteractionComponent() {
    const raw = [
...
exports.packInteractionComponent = packInteractionComponent;
function packNpcComponent() {
    /*const raw = [
...
exports.packNpcComponent = packNpcComponent;
exports.itemSchema = [
...
exports.lightWeightPcSchema = [
    ...
    },
    {
        name: "identity",
        type: "schema",
        fields: exports.identitySchema,
    },
    { name: "unknownByte1", type: "uint8", defaultValue: /*2*/ 2 },
    { name: "actorModelId", type: "uint32", defaultValue: 9240 },
    { name: "unknownDword1", type: "uint32", defaultValue: /*270*/ 270 },
    { name: "position", type: "floatvector3", defaultValue: [0, 80, 0] },
    { name: "rotation", type: "floatvector4", defaultValue: [0, 80, 0, 1] },
    { name: "unknownFloat1", type: "float", defaultValue: /*4.7*/ 4.7 },
    {
        name: "mountGuid",
        type: "uint64string",
...
exports.itemWeaponDetailSubSchema1 = [
    ...
    { name: "statData", type: "schema", fields: exports.statSchema },
];
...
function packItemWeaponData(obj) {
    const unknownData1Schema = [
        {
            name: "unknownData1",
            type: "schema",
    ...
    if (!obj["isWeapon"]) {
        return h1z1_dataschema_1.default.pack([{ name: "unknownBoolean1", type: "boolean", defaultValue: false }], obj).data;
    }
    return h1z1_dataschema_1.default.pack(unknownData1Schema, obj).data;
}
exports.packItemWeaponData = packItemWeaponData;
exports.currencySchema = [
    { name: "currencyId", type: "uint32", defaultValue: 0 },
    { name: "quantity", type: "uint32", defaultValue: 0 },
];
exports.rewardBundleSchema = [
    { name: "unknownBoolean1", type: "boolean", defaultValue: false },
    {
        name: "currency",
        type: "array",
        defaultValue: [],
        fields: exports.currencySchema,
    },
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
...
exports.collectionsSchema = [
    ...
    { name: "unknownDword6", type: "uint32", defaultValue: 0 },
    { name: "unknownDword7", type: "uint32", defaultValue: 0 },
    { name: "reward", type: "schema", fields: exports.rewardBundleSchema },
    {
        name: "unknownArray2",
        type: "array",
        defaultValue: [{}],
...
exports.objectiveSchema = [
    ...
    { name: "nameId", type: "uint32", defaultValue: 0 },
    { name: "descriptionId", type: "uint32", defaultValue: 0 },
    { name: "rewardData", type: "schema", fields: exports.rewardBundleSchema },
    { name: "unknownByte1", type: "uint8", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
    { name: "unknownDword4", type: "uint32", defaultValue: 0 },
    { name: "unknownByte2", type: "uint8", defaultValue: 0 },
...
exports.achievementSchema = [
    ...
    { name: "progress", type: "float", defaultValue: 0.0 },
    {
        ...
        fields: [
            ...
            { name: "objectiveData", type: "schema", fields: exports.objectiveSchema },
        ],
    },
...
exports.remoteWeaponExtraSchema = [
...
exports.fullNpcSchema = [
    ...
    { name: "unknownDword3", type: "uint32", defaultValue: 1 },
    {
        ...
        type: "array",
        defaultValue: [],
        fields: exports.attachmentSchema,
    },
    { name: "unknownString1", type: "string", defaultValue: "" },
    { name: "unknownString2", type: "string", defaultValue: "" },
    ...
    { name: "unknownDword7", type: "uint32", defaultValue: 1 },
    {
        ...
        type: "array",
        defaultValue: [],
        fields: exports.effectTagsSchema,
    },
    {
        name: "unknownData1",
        type: "schema",
    ...
    { name: "unknownDword18", type: "uint32", defaultValue: 0 },
    { name: "unknownDword19", type: "uint32", defaultValue: 0 },
    { name: "materialType", type: "uint32", defaultValue: 58 },
        ...
        fields: [
            {
                ...
                fields: [
                    { name: "resourceId", type: "uint32", defaultValue: 0 },
                    {
                        ...
                        type: "schema",
                        defaultValue: {},
                        fields: exports.characterResourceData,
                    },
                ],
            },
        ],
...
exports.containerData = [
    ...
    { name: "slots", type: "uint32", defaultValue: 0 },
    {
        ...
        fields: [
            { name: "itemDefinitionId", type: "uint32", defaultValue: 0 },
            { name: "itemData", type: "schema", fields: exports.itemSchema },
        ],
    },
...
exports.equipmentCharacterSchema = [
    { name: "profileId", type: "uint32", defaultValue: 3 },
    { name: "characterId", type: "uint64string", defaultValue: "0" },
];
exports.equipmentSlotSchema = [
...
exports.itemDefinitionSchema = [
    {
        ...
        flags: [
            ...
            { bit: 1, name: "COMBAT_ONLY", defaultValue: 0 },
            { bit: 2, name: "NO_LIVE_GAMER", defaultValue: 0 },
            { bit: 3, name: "SINGLE_USE", defaultValue: 0 },
            { bit: 4, name: "NON_MINI_GAME", defaultValue: 0 },
    ...
    },
    {
        ...
        flags: [
            ...
            { bit: 4, name: "FLAG_CAN_EQUIP", defaultValue: 0 },
            { bit: 5, name: "bit5", defaultValue: 0 },
            { bit: 6, name: "bit6", defaultValue: 0 },
    ...
    { name: "CURRENCY_TYPE", type: "int32", defaultValue: 0 },
    { name: "DATASHEET_ID", type: "uint32", defaultValue: 0 },
    { name: "ITEM_TYPE_1", type: "uint32", defaultValue: 0 },
    ...
    { name: "SCRAP_VALUE_OVERRIDE", type: "int32", defaultValue: 0 },
    {
        name: "stats",
        type: "array",
        defaultValue: [],
...
exports.packTargetData = packTargetData;
exports.passengerSchema = [
    { name: "characterId", type: "uint64string", defaultValue: "0" },
    {
        name: "identity",
        type: "schema",
