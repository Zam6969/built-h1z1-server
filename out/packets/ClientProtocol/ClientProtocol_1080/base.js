...
exports.basePackets = [
            ...
            fields: [
                {
                    ...
                    fields: [
                        ...
                        { name: "identity", type: "schema", fields: shared_2.identitySchema },
                        { name: "unknownDword11", type: "uint32", defaultValue: 0 },
                        {
                            name: "currency",
                            type: "array",
                            defaultValue: [],
                            fields: shared_1.currencySchema,
                        },
                        ...
                        },
                        {
                            ...
                            type: "array",
                            defaultValue: [],
                            fields: shared_1.collectionsSchema,
                        },
                        {
                            name: "inventory",
                            type: "schema",
                            ...
                            fields: [
                                {
                                    ...
                                    fields: [
                                        ...shared_1.itemSchema,
                                        {
                                            ...
                                            type: "custom",
                                            defaultValue: {},
                                            packer: shared_1.packItemWeaponData,
                                        },
                                    ],
                                },
                            ...
                            fields: [
                                {
                                    ...
                                    fields: [
                                        ...
                                        { name: "unknownDword6", type: "uint32", defaultValue: 0 },
                                        {
                                            ...
                                            type: "schema",
                                            defaultValue: {},
                                            fields: shared_2.rewardBundleSchema,
                                        },
                                        {
                                            name: "unknownArray1",
                                            type: "array",
                        ...
                        },
                        {
                            ...
                            type: "array",
                            defaultValue: [],
                            fields: shared_2.achievementSchema,
                        },
                        {
                            name: "acquaintances",
                            type: "array",
                        ...
                        { name: "unknownDword33", type: "uint32", defaultValue: 0 },
                        {
                            ...
                            type: "array",
                            defaultValue: [],
                            fields: shared_1.firemodesSchema,
                        },
                        {
                            name: "FIRE_MODES_2",
                            type: "array",
                        ...
                        },
                        {
                            ...
                            type: "schema",
                            defaultValue: {},
                            fields: shared_1.loadoutSlotsSchema,
                        },
                        {
                            name: "unknownArray27",
                            type: "array",
                        ...
                        },
                        {
                            ...
                            fields: [
                                { name: "resourceType", type: "uint32", defaultValue: 0 },
                                {
                                    ...
                                    type: "schema",
                                    defaultValue: {},
                                    fields: shared_1.characterResourceData,
                                },
                            ],
                        },
                        {
    ...
    [
        ...
        0x0b,
        {
            fields: [
                ...
                { name: "skyData", type: "schema", fields: shared_2.skyData },
    ...
    [
        ...
        0x61,
        {
            fields: [
                ...
                { name: "interactGlowAndDist", type: "uint32", defaultValue: 3 },
                { name: "unknownBoolean1", type: "boolean", defaultValue: false },
        ...
        0x79,
        {
            fields: [
                ...
                },
                {
                    name: "positionUpdate",
                    type: "custom",
                    parser: shared_1.readPositionUpdateData,
                    packer: shared_1.packPositionUpdateData,
                },
            ],
        },
    ],
            ...
            fields: [
                {
                    name: "weaponPacket",
                    type: "custom",
                    parser: weapon_1.parseWeaponPacket,
                    packer: weapon_1.packWeaponPacket,
                },
            ],
        },
    ],
    ...
    [
        ...
        {
            fields: [
                { name: "clientHoursMs", type: "uint64string", defaultValue: "0" },
    ...
    [
        ...
        0xcd05,
        {
            fields: [
                ...
                { name: "lockType", type: "uint32", defaultValue: 1 },
    ...
    [
        ...
        0xd6,
        {
            fields: shared_1.lightWeightPcSchema,
        },
    ],
    [
        "AddLightweightNpc",
        0xd7,
        {
            fields: shared_1.lightWeightNpcSchema,
        },
    ],
    [
        ...
        {
            fields: [
                { name: "npcData", type: "schema", fields: shared_1.lightWeightNpcSchema },
    ...
    ["LightweightToFullPc", 0xda, { fields: shared_1.fullPcSchema }],
    [
        "LightweightToFullNpc",
        0xdb,
        {
            fields: shared_1.fullNpcSchema,
        },
    ],
    [
        ...
        {
            fields: [
                { name: "npcData", type: "schema", fields: shared_1.fullNpcSchema },
                { name: "unknownByte1", type: "uint8", defaultValue: 0 },
                { name: "unknownDword1", type: "uint32", defaultValue: 0 },
                {
                    name: "unknownArray1",
        ...
        0xeb,
        {
            fields: [
                ...
                },
                {
                    name: "rawComponent",
                    type: "custom",
                    parser: shared_1.packInteractionComponent,
                    packer: shared_1.packInteractionComponent,
                    defaultValue: shared_1.packInteractionComponent,
                },
            ],
        },
    ],
        ...
        0xeb04,
        {
            fields: [
                ...
                { name: "nameId", type: "uint32", defaultValue: 0 },
                {
                    name: "rawComponent",
                    type: "custom",
                    parser: shared_1.packNpcComponent,
                    packer: shared_1.packNpcComponent,
                    defaultValue: shared_1.packNpcComponent,
                },
            ],
        },
    ],
