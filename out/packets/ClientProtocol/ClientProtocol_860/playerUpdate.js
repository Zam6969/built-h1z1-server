...
exports.playerUpdatePackets = void 0;
const shared_1 = require("./shared");
exports.playerUpdatePackets = [
        ...
        0x0f50,
        {
            fields: [
                { name: "characterId", type: "uint64string", defaultValue: "0" },
                {
                    ...
                    type: "array",
                    defaultValue: [],
                    fields: shared_1.statDataSchema,
                },
            ],
        },
    ],
    ...
    ["PlayerUpdate.LightweightToFullPc", 0x0f5a, { fields: shared_1.fullPcDataSchema }],
    [
        "PlayerUpdate.LightweightToFullNpc",
        0x0f5b,
        {
            fields: shared_1.fullNpcDataSchema,
        },
    ],
    [
        ...
        {
            fields: [
                { name: "npcData", type: "schema", fields: shared_1.fullNpcDataSchema },
                { name: "unknownByte1", type: "uint8", defaultValue: 0 },
                { name: "unknownDword1", type: "uint32", defaultValue: 0 },
                {
                    name: "unknownArray1",
