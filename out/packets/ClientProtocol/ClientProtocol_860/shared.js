...
exports.itemWeaponDetailSchema = exports.itemWeaponDetailSubSchema2 = exports.itemWeaponDetailSubSchema1 = exports.itemDetailSchema = exports.targetDataSchema = exports.effectTagDataSchema = exports.itemBaseSchema = exports.facilityStatsDataSchema = exports.vehicleStatsDataSchema = exports.weaponStatsDataSchema = exports.weaponStatsDataSubSchema1 = exports.profileStatsSubSchema1 = exports.skyData = exports.baseItemDefinitionSchema = exports.itemDataSchema = exports.EquippedContainersSchema = exports.vehicleReferenceDataSchema = exports.identitySchema = exports.profileDataSchema = exports.lootItemSchema = exports.currencySchema = exports.respawnLocationDataSchema = exports.loadoutDataSubSchema2 = exports.loadoutDataSubSchema1 = exports.achievementDataSchema = exports.objectiveDataSchema = exports.rewardBundleDataSchema = exports.resourceEventDataSubSchema = exports.fullNpcDataSchema = exports.fullPcDataSchema = exports.lightWeightNpcSchema = exports.statDataSchema = exports.lightWeightPcSchema = exports.packItemData = exports.parseItemData = exports.parseItemAddData = exports.packVehicleReferenceData = exports.parseVehicleReferenceData = exports.packItemSubData = exports.packItemDefinitionData = exports.packPositionUpdateData = exports.readPositionUpdateData = exports.packSignedIntWith2bitLengthValue = exports.readSignedIntWith2bitLengthValue = exports.packUnsignedIntWith2bitLengthValue = exports.readUnsignedIntWith2bitLengthValue = exports.writePacketType = exports.readPacketType = void 0;
...
exports.readPacketType = readPacketType;
function writePacketType(packetType) {
    const packetTypeBytes = (0, utils_1.getPacketTypeBytes)(packetType);
...
exports.writePacketType = writePacketType;
...
exports.readUnsignedIntWith2bitLengthValue = readUnsignedIntWith2bitLengthValue;
...
exports.packUnsignedIntWith2bitLengthValue = packUnsignedIntWith2bitLengthValue;
...
exports.readSignedIntWith2bitLengthValue = readSignedIntWith2bitLengthValue;
...
exports.packSignedIntWith2bitLengthValue = packSignedIntWith2bitLengthValue;
function readPositionUpdateData(data, offset) {
    ...
    if (obj.flags & 0x200) {
        ...
        obj["rotation"] = (0, utils_1.eul2quat)(new Float32Array(rotationEul));
        obj["rotationRaw"] = rotationEul;
        obj["lookAt"] = (0, utils_1.eul2quat)(new Float32Array([rotationEul[0], 0, 0, 0]));
        offset += v.length;
    }
    if (obj.flags & 0x400) {
        v = readSignedIntWith2bitLengthValue(data, offset);
...
exports.readPositionUpdateData = readPositionUpdateData;
function packPositionUpdateData(obj) {
    let data = Buffer.allocUnsafe(7), flags = 0, v;
...
exports.packPositionUpdateData = packPositionUpdateData;
function packItemDefinitionData(obj) {
    ...
    for (step = 0; step < obj["stats"].length; step++) {
        ...
        switch (obj["stats"][step]["statData"]["statValue"]["type"]) {
            case 0:
                v.writeUInt32LE(obj["stats"][step]["statData"]["statValue"]["value"]["base"], 0);
                data = Buffer.concat([data, v]);
                v.writeUInt32LE(obj["stats"][step]["statData"]["statValue"]["value"]["modifier"], 0);
                data = Buffer.concat([data, v]);
                break;
            case 1:
                v.writeFloatLE(obj["stats"][step]["statData"]["statValue"]["value"]["base"], 0);
                data = Buffer.concat([data, v]);
                v.writeFloatLE(obj["stats"][step]["statData"]["statValue"]["value"]["modifier"], 0);
                data = Buffer.concat([data, v]);
                break;
            default:
        }
    ...
    const input = data;
    let output = Buffer.alloc(utils_1.LZ4.encodeBound(input.length));
    const compressedSize = utils_1.LZ4.encodeBlock(input, output);
...
exports.packItemDefinitionData = packItemDefinitionData;
function packItemSubData(obj) {
    ...
    data = Buffer.concat([data, v]);
    if (obj.unknownDword1 <= 0)
        return data;
    const unknownData1Obj = h1z1_dataschema_1.default.pack(unknownData1Schema, obj["unknownData1"]).data;
    return Buffer.concat([data, unknownData1Obj]);
}
exports.packItemSubData = packItemSubData;
function parseVehicleReferenceData(data, offset) {
    ...
    data = (0, utils_1.lz4_decompress)(compData, inSize, outSize);
    const result = h1z1_dataschema_1.default.parse(exports.vehicleReferenceDataSchema, data, 0).result;
    return {
        value: result,
        length: dataLength + 4,
    };
}
exports.parseVehicleReferenceData = parseVehicleReferenceData;
function packVehicleReferenceData(obj) {
    const data = h1z1_dataschema_1.default.pack(exports.vehicleReferenceDataSchema, obj);
    return data;
}
exports.packVehicleReferenceData = packVehicleReferenceData;
function parseItemAddData(data, offset, referenceData) {
    ...
    const inSize = itemData.readUInt16LE(0), outSize = itemData.readUInt16LE(2), compData = itemData.slice(4, 4 + inSize), decompData = (0, utils_1.lz4_decompress)(compData, inSize, outSize), itemDefinition = h1z1_dataschema_1.default.parse(exports.baseItemDefinitionSchema, decompData, 0).result;
...
exports.parseItemAddData = parseItemAddData;
function parseItemData(data, offset, referenceData) {
    const startOffset = offset;
    let detailSchema;
    const baseItem = h1z1_dataschema_1.default.parse(exports.itemBaseSchema, data, offset);
    offset += baseItem.length;
    if (referenceData &&
        referenceData.itemTypes[baseItem.result.itemId] === "Weapon") {
        detailSchema = exports.itemWeaponDetailSchema;
    }
    else {
        detailSchema = exports.itemDetailSchema;
    }
    const detailItem = h1z1_dataschema_1.default.parse(detailSchema, data, offset);
...
exports.parseItemData = parseItemData;
...
exports.packItemData = packItemData;
exports.lightWeightPcSchema = [
...
exports.lightWeightNpcSchema = [
    ...
    { name: "positionUpdateType", type: "uint8", defaultValue: 0 },
...
exports.resourceEventDataSubSchema = [
    {
...
exports.rewardBundleDataSchema = [
...
exports.objectiveDataSchema = [
    { name: "objectiveId", type: "uint32", defaultValue: 0 },
    { name: "nameId", type: "uint32", defaultValue: 0 },
    { name: "descriptionId", type: "uint32", defaultValue: 0 },
    { name: "rewardData", type: "schema", fields: exports.rewardBundleDataSchema },
    { name: "unknownByte1", type: "uint8", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
    { name: "unknownDword4", type: "uint32", defaultValue: 0 },
    { name: "unknownByte2", type: "uint8", defaultValue: 0 },
...
exports.achievementDataSchema = [
    ...
    { name: "progress", type: "float", defaultValue: 0.0 },
    {
        ...
        fields: [
            ...
            { name: "objectiveData", type: "schema", fields: exports.objectiveDataSchema },
        ],
    },
...
exports.respawnLocationDataSchema = [
...
exports.EquippedContainersSchema = {
...
exports.baseItemDefinitionSchema = [
    { name: "itemId", type: "uint32", defaultValue: 0 },
    {
        name: "flags1",
        type: "bitflags",
...
exports.profileStatsSubSchema1 = [
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    {
        name: "unknownArray1",
        type: "array",
...
exports.weaponStatsDataSubSchema1 = [
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
    { name: "unknownDword4", type: "uint32", defaultValue: 0 },
...
exports.weaponStatsDataSchema = [
    { name: "unknownData1", type: "schema", fields: exports.profileStatsSubSchema1 },
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
    { name: "unknownDword4", type: "uint32", defaultValue: 0 },
    ...
    { name: "unknownDword10", type: "uint32", defaultValue: 0 },
    { name: "unknownDword11", type: "uint32", defaultValue: 0 },
    { name: "unknownData2", type: "schema", fields: exports.weaponStatsDataSubSchema1 },
    { name: "unknownData3", type: "schema", fields: exports.weaponStatsDataSubSchema1 },
];
exports.vehicleStatsDataSchema = [
    { name: "unknownData1", type: "schema", fields: exports.profileStatsSubSchema1 },
    { name: "unknownData2", type: "schema", fields: exports.weaponStatsDataSubSchema1 },
];
exports.facilityStatsDataSchema = [
    { name: "unknownData1", type: "schema", fields: exports.weaponStatsDataSubSchema1 },
];
exports.itemBaseSchema = [
    { name: "itemId", type: "uint32", defaultValue: 0 },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    {
        name: "unknownGuid1",
...
exports.targetDataSchema = [
    { name: "targetType", type: "uint8", defaultValue: 0 },
];
exports.itemDetailSchema = [
    { name: "unknownBoolean1", type: "boolean", defaultValue: false },
];
exports.itemWeaponDetailSubSchema1 = [
    { name: "statOwnerId", type: "uint32", defaultValue: 0 },
    { name: "statData", type: "schema", fields: exports.statDataSchema },
];
exports.itemWeaponDetailSubSchema2 = [
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    {
        name: "unknownArray1",
        type: "array",
        ...
        fields: [
            { name: "unknownDword1", type: "uint32", defaultValue: 0 },
            {
                ...
                type: "array",
                defaultValue: [],
                fields: exports.itemWeaponDetailSubSchema1,
            },
        ],
    },
];
exports.itemWeaponDetailSchema = [
    { name: "unknownBoolean1", type: "boolean", defaultValue: false },
    {
        name: "unknownArray1",
        type: "array",
    ...
    },
    {
        ...
        type: "array",
        defaultValue: [],
        fields: exports.itemWeaponDetailSubSchema2,
    },
];
