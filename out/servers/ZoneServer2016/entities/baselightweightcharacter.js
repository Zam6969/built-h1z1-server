...
exports.BaseLightweightCharacter = void 0;
...
class BaseLightweightCharacter extends baseentity_1.BaseEntity {
    constructor(characterId, transientId, actorModelId, position, rotation, server) {
        ...
        this.headActor = getHeadActor(this.actorModelId);
        this.profileId = 0;
        this.nameId = 0;
        this.state = {
            position: position,
...
exports.BaseLightweightCharacter = BaseLightweightCharacter;
//# sourceMappingURL=baselightweightcharacter.js.map