...
exports.foundationRampSlotDefinitions = exports.foundationExpansionSlotDefinitions = exports.shelterSlotDefinitions = exports.upperWallSlotDefinitions = exports.wallSlotDefinitions = void 0;
const enums_1 = require("../models/enums");
// ALL DOOR SLOTS ARE TREATED AS WALL SLOTS INTERNALLY FOR SIMPLICITY
exports.wallSlotDefinitions = {
    // #region FOUNDATION
    [enums_1.Items.GROUND_TAMPER]: {
        yOffset: 0.6542,
        authorizedItems: [enums_1.Items.METAL_WALL, enums_1.Items.METAL_GATE, enums_1.Items.METAL_DOORWAY],
        offsets: [
    ...
    [enums_1.Items.SHACK_SMALL]: {
        yOffset: 0.8809,
        authorizedItems: [enums_1.Items.DOOR_METAL, enums_1.Items.DOOR_WOOD],
        offsets: [2.0476],
        angles: [126.695],
        rotationOffsets: [0],
    },
    ...
    [enums_1.Items.SHACK_BASIC]: {
        yOffset: -0.0126,
        authorizedItems: [enums_1.Items.DOOR_BASIC],
        offsets: [0.952],
        angles: [-173.1957],
        rotationOffsets: [0],
    },
...
exports.upperWallSlotDefinitions = {
    [enums_1.Items.METAL_WALL]: {
        yOffset: 2.3817,
        authorizedItems: [enums_1.Items.METAL_WALL_UPPER],
        offsets: [0],
        angles: [0],
        rotationOffsets: [0],
    },
...
exports.shelterSlotDefinitions = {
    [enums_1.Items.GROUND_TAMPER]: {
        yOffset: 0.6542,
        authorizedItems: [
            enums_1.Items.SHELTER,
...
exports.foundationExpansionSlotDefinitions = {
    [enums_1.Items.FOUNDATION]: {
        yOffset: 2.1286,
        authorizedItems: [enums_1.Items.FOUNDATION_EXPANSION],
        offsets: [7.5027, 7.3413, 7.501, 7.6587],
        angles: [-88.7862, -179.9943, 88.7859, -0.0055],
        rotationOffsets: [3.1416, -1.5708, 0, 1.5708],
    },
};
exports.foundationRampSlotDefinitions = {
    [enums_1.Items.FOUNDATION]: {
        yOffset: 2.1286,
        authorizedItems: [enums_1.Items.FOUNDATION_RAMP, enums_1.Items.FOUNDATION_STAIRS],
        offsets: [
...
//# sourceMappingURL=constructionslots.js.map