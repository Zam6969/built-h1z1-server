...
exports.H1emuZoneServer = void 0;
const h1emuserver_1 = require("./shared/h1emuserver");
const debug = require("debug")("H1emuServer");
class H1emuZoneServer extends h1emuserver_1.H1emuServer {
    constructor(serverId, serverPort) {
        super(serverPort);
        this._maxConnectionRetry = 0;
        this._hasBeenConnectedToLogin = false;
        this.messageHandler = (messageType, data, client) => {
    ...
    connect() {
        this.sendData(this._loginServerInfo, "SessionRequest", this._sessionData);
    ...
    start() {
        ...
        this._pingTimer = setTimeout(() => {
            this.ping(this._loginConnection);
        }, this._pingTime);
    }
}
exports.H1emuZoneServer = H1emuZoneServer;
//# sourceMappingURL=h1emuZoneServer.js.map