...
exports.H1emuProtocol = exports.H1emuPacketsPackets = exports.H1emuPacketsPacketTypes = void 0;
const debug = require("debug")("H1emuProtocol");
const h1z1_dataschema_1 = __importDefault(require("h1z1-dataschema"));
const packettable_1 = __importDefault(require("../packets/packettable"));
const packets = [
    [
        "SessionRequest",
        0x01,
...
_a = (0, packettable_1.default)(packets), exports.H1emuPacketsPacketTypes = _a[0], exports.H1emuPacketsPackets = _a[1];
const H1emuPackets = {
    PacketTypes: exports.H1emuPacketsPacketTypes,
    Packets: exports.H1emuPacketsPackets,
};
class H1emuProtocol {
    parse(data) {
    ...
    pack(packetName, object) {
        const packetType = H1emuPackets.PacketTypes[packetName], packet = H1emuPackets.Packets[packetType];
        let data;
        if (packet) {
            if (packet.schema) {
                const packetData = h1z1_dataschema_1.default.pack(packet.schema, object);
                if (packetData) {
...
exports.H1emuPackets = H1emuPackets;
//# sourceMappingURL=h1emuprotocol.js.map