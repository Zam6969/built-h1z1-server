    ...
    parse(data) {
        ...
        if (packet) {
            if (packet.name === "TunnelAppPacketClientToServer") {
                const { schema, name } = this.tunnelLoginPackets.Packets[data.readUInt8(14)];
...
exports.LoginProtocol2016 = LoginProtocol2016;
//# sourceMappingURL=loginprotocol2016.js.map